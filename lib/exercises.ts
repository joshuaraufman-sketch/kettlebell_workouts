 ...
 *
 * Source of truth: Kettlebell Exercise Database (V2.4). This string is fed to
 * the model verbatim so it has a consistent movement vocabulary, categories,
 * prerequisites, rep schemes, and form cues to draw from when generating
 * workouts.
 */
export const EXERCISE_DATABASE = `# Kettlebell Exercise Database
...
/**
 * Prompt-friendly rendering of the exercise database, used to give the model a
 * canonical movement vocabulary to choose from.
 */
